...
*/ 
    ...
    public function save(){
        $db = new DbHandlers();
        $sql = "INSERT INTO shipping_rates(";
        if (isset($this->id) && $this->id!=="" ) {
             $sql.= 'id';    
        }
        if (isset($this->rate) && $this->rate!=="" ) {
            $sql.= ',rate';    
        }
    ...
    public function view($critcol=null, $critval=null) {
        $db = new DbHandlers();
        if(is_null($critcol)){
            $sql = "SELECT * from shipping_rates order by id DESC";
        } else {
        $sql = "SELECT * from shipping_rates WHERE $critcol ='{$critval}'";
        }
    ...
    public  function delete($critcol, $critval){
        $db = new DbHandlers();
        $sql = "DELETE FROM shipping_rates WHERE $critcol ='{$critval}'";
