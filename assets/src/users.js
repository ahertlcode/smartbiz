...
app.controller ('usersCtrl', function($scope, $http) {
    ...
    this.user = {user:user, id:'', last_name:'', first_name:'', middle_name:'', e_mail:'', mobile_phone:'', address:'', date_registered:'', lastlogin:'', first_login_ip:'', last_login_ip:'', role:'', date_created:'', date_updated:'', date_deleted:'', status:''};
